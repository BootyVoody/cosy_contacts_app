...
import 'package:cosy_contacts/presentation/screens/detailed_contact/detailed_contact.dart';
...
class NavigatorHelper {
  ...
  void navigateToDetailedContact({
    required BuildContext context,
    required int contactId,
  }) =>
      Navigator.pushNamed(
        context,
        DetailedContact.route,
        arguments: IntScreenArgument(contactId),
      );
}
