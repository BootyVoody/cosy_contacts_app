...
import 'package:cosy_contacts/presentation/widgets/search_text_field.dart';
  ...
  Widget buildBody(BuildContext context, ContactsCubit cubit, int subgroupId) {
    switch (cubit.state.loadingStatus) {
      ...
      case LoadingStatus.done:
        ...
        return buildContactCards(context, cubit.state.filteredContacts);
  ...
  Widget buildContactCards(
    ...
    List<ShortenedContactModel> contacts,
      ...
      ListView(
        ...
        children: contacts
            .map((contact) => ShortenedContactCard(
                  contact: contact,
                  onTap: () => navigator.navigateToDetailedContact(
                    context: context,
